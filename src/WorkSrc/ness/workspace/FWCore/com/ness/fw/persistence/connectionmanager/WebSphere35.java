 ...
 * @version $Id: WebSphere35.java,v 1.1 2005/02/21 15:07:11 baruch Exp $
 */
 ...
 * manages connections for Websphere Application Server version 3.5.X.
 */
public class WebSphere35 extends AbstractConnectionManager
{
	/**
	 * Data Source lookup string
	 */
	private static final String DATA_SOURCE_LOOKUP = "com.ibm.ejs.ns.jndi.CNInitialContextFactory";
	 ...
	 */
	public WebSphere35(String connectionManagerName, SystemProperties dbProperties) 
	{
