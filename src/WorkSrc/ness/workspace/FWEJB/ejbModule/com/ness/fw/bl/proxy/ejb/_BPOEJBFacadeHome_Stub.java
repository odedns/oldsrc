...
public class _BPOEJBFacadeHome_Stub extends Stub implements BPOEJBFacadeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ness.fw.bl.proxy.ejb.BPOEJBFacadeHome:0000000000000000", 
    ...
    public BPOEJBFacade create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (BPOEJBFacade) in.read_Object(BPOEJBFacade.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.ness.fw.bl.proxy.ejb.BPOEJBFacadeHome.class);
            if (so == null) {
                return create();
            }
            try {
                BPOEJBFacade result = ((com.ness.fw.bl.proxy.ejb.BPOEJBFacadeHome)so.servant).create();
                return (BPOEJBFacade)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
