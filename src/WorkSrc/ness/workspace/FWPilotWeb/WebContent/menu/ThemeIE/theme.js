...
var cmThemeIEBase = 'menu/ThemeIE/';
var cmThemeIEImagesBase = SYSTEM_DIR + '/';
...
var cmThemeIE =
{
	...
	// HTML code to the left of the folder item
	folderLeft: '<img alt="" src="' + cmThemeIEBase + cmThemeIEImagesBase + 'folder.gif">',
	// HTML code to the right of the folder item
	folderRight: '<img alt="" src="' + cmThemeIEBase + cmThemeIEImagesBase + 'arrow.gif">',
	// HTML code to the left of the regular item
	itemLeft: '<img alt="" src="' + cmThemeIEBase + cmThemeIEImagesBase + 'link.gif">',
	// HTML code to the right of the regular item
	itemRight: '',
