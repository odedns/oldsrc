 ...
 * @version $Id: SexVOFactory.java,v 1.1 2005/02/21 17:07:22 baruch Exp $
 */
 ...
 */
public class SexVOFactory extends CodeTableVoFactory
{

	private static final String FILE_NAME = "fwpilot/customer/dao/sql";
	private static final String PREFIX    = "sex";
	
	public static SexStatus getById(int id) throws FatalException
	{
		CodeTable codeTable;
		try
		{
		...
		return new SexStatus(codeTable.getId(),codeTable.getName()); 	 
	}
	...
	public static List getAll() throws FatalException
	{
		...
		for (int i=0; i<list.size(); i++)
		{
			...
			newList.add(new SexStatus(codeTable.getId(),codeTable.getName()));			
		}
