 ...
 * @version $Id: FamilyMemberVOFactory.java,v 1.1 2005/02/21 17:07:22 baruch Exp $
 */
 ...
 */
public class FamilyMemberVOFactory extends CodeTableVoFactory
{

	private static final String FILE_NAME = "fwpilot/customer/dao/sql";
	private static final String PREFIX    = "familyMemberStatus";
	
	public static FamilyMemberStatus getById(int id) throws FatalException
	{
		CodeTable codeTable;
		try
		{
		...
		return new FamilyMemberStatus(codeTable.getId(),codeTable.getName()); 	 
	}
	...
	public static List getAll() throws FatalException
	{
		...
		for (int i=0; i<list.size(); i++)
		{
			...
			newList.add(new FamilyMemberStatus(codeTable.getId(),codeTable.getName()));			
		}
