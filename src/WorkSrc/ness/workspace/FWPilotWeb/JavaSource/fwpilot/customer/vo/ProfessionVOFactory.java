 ...
 * @version $Id: ProfessionVOFactory.java,v 1.1 2005/02/21 17:07:22 baruch Exp $
 */
 ...
 */
public class ProfessionVOFactory extends CodeTableVoFactory
{

	private static final String FILE_NAME = "fwpilot/customer/dao/sql";
	private static final String PREFIX    = "profession";
	
	public static Profession getById(int id) throws FatalException
	{
		CodeTable codeTable;
		try
		{
		...
		return new Profession(codeTable.getId(),codeTable.getName()); 	 
	}
	...
	public static List getAll() throws FatalException
	{
		...
		for (int i=0; i<list.size(); i++)
		{
			...
			newList.add(new Profession(codeTable.getId(),codeTable.getName()));			
		}
