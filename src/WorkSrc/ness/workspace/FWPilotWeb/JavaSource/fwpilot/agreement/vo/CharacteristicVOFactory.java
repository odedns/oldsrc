 ...
 * @version $Id: CharacteristicVOFactory.java,v 1.1 2005/02/21 17:07:23 baruch Exp $
 */
 ...
 */
public class CharacteristicVOFactory extends CodeTableVoFactory
{

	private static final String FILE_NAME = "fwpilot/agreement/dao/sql";
	private static final String PREFIX    = "characteristic";
	
	public static Characteristic getById(int id) throws FatalException
	{
		CodeTable codeTable;
		try
		{
			//	codeTable = getById(FILE_NAME, PREFIX, id);
		...
		return new Characteristic(codeTable.getId(),codeTable.getName()); 	 
	}
	...
	public static List getAll() throws FatalException
	{
		...
		for (int i=0; i<list.size(); i++)
		{
			...
			newList.add(new Characteristic(codeTable.getId(),codeTable.getName()));			
		}
		return newList;
	}
}
