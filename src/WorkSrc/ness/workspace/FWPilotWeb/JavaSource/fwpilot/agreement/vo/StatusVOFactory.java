 ...
 * @version $Id: StatusVOFactory.java,v 1.1 2005/02/21 17:07:23 baruch Exp $
 */
 ...
 */
public class StatusVOFactory extends CodeTableVoFactory
{

	private static final String FILE_NAME = "fwpilot/agreement/dao/sql";
	private static final String PREFIX    = "status";
	
	public static Status getById(int id) throws FatalException 
	{
		CodeTable codeTable;
		try
		{
		...
		return new Status(codeTable.getId(),codeTable.getName()); 	 
	}
	...
	public static List getAll() throws FatalException 
	{
		...
		for (int i=0; i<list.size(); i++)
		{
			...
			newList.add(new Status(codeTable.getId(),codeTable.getName()));			
		}
