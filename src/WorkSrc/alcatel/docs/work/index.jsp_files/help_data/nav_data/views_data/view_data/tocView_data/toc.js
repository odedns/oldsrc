 ...
 * 	2004/9/21 - Updated by nlp for HPSYS00000131
 *	2004/9/23 - Updated by luyi for HPSYS00000137
 *	2004/9/23 - Updated by luyi for HPSYS00000138
 *      2004/9/23 - Updated by luyi for HPSYS00000142(2004/9/30 replace these codes with codes from canada)
 *      2004/9/23 - Updated by luyi for HPSYS00000154(2004/9/30 replace these codes with codes from canada)
 *	2004/9/24 - Updated by luyi for HPSYS00000151
 *	2004/9/24 - Updated by luyi for HPSYS00000140,155,141
 *	2004/9/24 - Updated by luyi for HPSYS00000139
 *	2004/9/27 - Updated by luyi for new banned bug(up/down arrow cannot move in sub topic)(2004/9/30 replace these codes with codes from canada)
 *	2004/9/30 - Updated by luyi for HPSYS00000142,154 to merge codes from canada
 *      2004/11/3 - Updated by luyi for HPSYS00000214
 *      2004/11/16 - Updated by luyi for HPSYS00000214 modify
 *      2004/11/17 - Updated by Jiang Linquan for HPSYS00000214 add
 *******************************************************************************/
...
function getNextSibling(node) 
{
	...
	//HPSYS00000142 
	while (sib && (sib.nodeType == 3 || sib.tagName=="SCRIPT")) // text node
		sib = sib.nextSibling;
	//end HPSYS00000142 code from canada
	return sib;
}
...
{	
	//HPSYS00000151 part 1 of 2	
  	if (parent == null) return null;	
  	//end HPSYS00000151 part 1 of 2
...
function getAnchorNode(node) {
  //HPSYS00000151 part 2 of 2	
  if (node == null) return null;	
  //end HPSYS00000151 part 2 of 2
...
function selectTopic(topic)
{
    ...
    //end of HPSYS00000214 add
		
		
		j = links[i].href.indexOf('#');
		if (j != -1){
			templink = links[i].href.substring(0, j);
		}
		else    
...
if (isMozilla) {
  ...
  //HPSYS00000139 part 2 of 2
  //HPSYS00000140,155,141
  //window.onfocus = focusHandler;
  //end HPSYS00000140,155,141
  //end HPSYS00000139 part 2 of 2
}
