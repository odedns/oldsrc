...
public class _NotificationSink_Stub extends Stub implements NotificationSink {
    ...
    public void handleEvent(TaskNotificationInfo arg0) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        org.omg.CORBA_2_3.portable.OutputStream out = 
                            ...
                            _request("handleEvent", true);
                        out.write_value(arg0,TaskNotificationInfo.class);
                        _invoke(out);
                        return;
                    } catch (ApplicationException ex) {
                        in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                ...
                ServantObject so = _servant_preinvoke("handleEvent",com.ibm.websphere.scheduler.NotificationSink.class);
                if (so == null) {
                    continue;
                }
                try {
                    TaskNotificationInfo arg0Copy = (TaskNotificationInfo) Util.copyObject(arg0,_orb());
                    ((com.ibm.websphere.scheduler.NotificationSink)so.servant).handleEvent(arg0Copy);
                    return;
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
