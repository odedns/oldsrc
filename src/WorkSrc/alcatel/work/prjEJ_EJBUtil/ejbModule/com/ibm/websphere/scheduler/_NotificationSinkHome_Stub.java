...
public class _NotificationSinkHome_Stub extends Stub implements NotificationSinkHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ibm.websphere.scheduler.NotificationSinkHome:0000000000000000", 
    ...
    public NotificationSink create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (NotificationSink) in.read_Object(NotificationSink.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ibm.websphere.scheduler.NotificationSinkHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    NotificationSink result = ((com.ibm.websphere.scheduler.NotificationSinkHome)so.servant).create();
                    return (NotificationSink)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
