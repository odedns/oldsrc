...
public class _EJSRemoteStatelessReceiveNotification_3af8bc0f_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteStatelessReceiveNotification_3af8bc0f target = null;
    private ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:com.ibm.websphere.scheduler.NotificationSink:0000000000000000", 
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteStatelessReceiveNotification_3af8bc0f) target;
    }
        ...
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 101: 
                    ...
                    } else if (method.equals("handleEvent")) {
                        return handleEvent(in, reply);
                    }
                case 104: 
    ...
    private OutputStream handleEvent(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        TaskNotificationInfo arg0 = (TaskNotificationInfo) in.read_value(TaskNotificationInfo.class);
        target.handleEvent(arg0);
        OutputStream out = reply.createReply();
        return out;
    }
}
