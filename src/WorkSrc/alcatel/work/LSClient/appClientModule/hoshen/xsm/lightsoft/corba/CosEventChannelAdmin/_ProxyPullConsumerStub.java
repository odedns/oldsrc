...
/**
* hoshen/xsm/lightsoft/corba/CosEventChannelAdmin/_ProxyPullConsumerStub.java .
...
/**
    ...
    */
public class _ProxyPullConsumerStub extends org.omg.CORBA_2_3.portable.ObjectImpl implements hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.ProxyPullConsumer
{
  // Constructors
  ...
  /**
       ...
       */
  public void connect_pull_supplier (hoshen.xsm.lightsoft.corba.CosEventComm.PullSupplier pull_supplier) throws hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.AlreadyConnected, hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.TypeError
  {
    if ( !this._is_local() ) {
      org.omg.CORBA.portable.InputStream _in = null;
      try {
         org.omg.CORBA.portable.OutputStream _out = _request ("connect_pull_supplier",true);
        ...
        connect_pull_supplier( pull_supplier ); return;
      ...
      org.omg.CORBA.portable.ServantObject _so =
        _servant_preinvoke( "connect_pull_supplier",_opsClass );
      if ( _so == null ) { connect_pull_supplier( pull_supplier ); return; }
      try {
         ((hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.ProxyPullConsumerOperations)_so.servant).connect_pull_supplier( pull_supplier );
         return;
  ...
  public void disconnect_pull_consumer ()
  {
    if ( !this._is_local() ) {
      ...
      try {
        ...
        disconnect_pull_consumer(  ); return;
      } catch (org.omg.CORBA.portable.UnknownException _ue) {
        Throwable _oe = _ue.originalEx;
        if (_oe instanceof Error)
            throw (Error)_oe;
      ...
      if ( _so == null ) { disconnect_pull_consumer(  ); return; }
      try {
  ...
  final public static java.lang.Class _opsClass =
    hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.ProxyPullConsumerOperations.class;
