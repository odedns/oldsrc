...
public class _MytestHome_Stub extends Stub implements MytestHome {
    
    private static final String[] _type_ids = {
        "RMI:onjlib.ejb.mytest.MytestHome:0000000000000000", 
        ...
        if (!Util.isLocal(this)) {
            try {
                ...
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Mytest) in.read_Object(Mytest.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",onjlib.ejb.mytest.MytestHome.class);
            if (so == null) {
                return create();
            }
            try {
                Mytest result = ((onjlib.ejb.mytest.MytestHome)so.servant).create();
                return (Mytest)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
