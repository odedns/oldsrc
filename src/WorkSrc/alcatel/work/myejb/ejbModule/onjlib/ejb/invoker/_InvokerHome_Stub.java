...
public class _InvokerHome_Stub extends Stub implements InvokerHome {
    ...
    private static final String[] _type_ids = {
        "RMI:onjlib.ejb.invoker.InvokerHome:0000000000000000", 
    ...
    public Invoker create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("create",onjlib.ejb.invoker.InvokerHome.class);
            if (so == null) {
                return create();
            }
            try {
                Invoker result = ((onjlib.ejb.invoker.InvokerHome)so.servant).create();
