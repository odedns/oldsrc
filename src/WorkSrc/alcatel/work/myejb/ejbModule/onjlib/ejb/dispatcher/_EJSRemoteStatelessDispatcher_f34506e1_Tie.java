...
public class _EJSRemoteStatelessDispatcher_f34506e1_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessDispatcher_f34506e1 target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:onjlib.ejb.dispatcher.Dispatcher:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessDispatcher_f34506e1) target;
    }
            ...
            switch (method.charAt(5)) {
                ...
                case 116: 
                    if (method.equals("executeCommand")) {
                        return executeCommand(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream executeCommand(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        CommandParams arg0 = (CommandParams) in.read_value(CommandParams.class);
        CommandParams result = target.executeCommand(arg0);
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,CommandParams.class);
        return out;
    }
}
