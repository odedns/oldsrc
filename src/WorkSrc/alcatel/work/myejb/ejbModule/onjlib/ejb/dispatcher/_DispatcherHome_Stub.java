...
public class _DispatcherHome_Stub extends Stub implements DispatcherHome {
    
    private static final String[] _type_ids = {
        "RMI:onjlib.ejb.dispatcher.DispatcherHome:0000000000000000", 
    ...
    public Dispatcher create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Dispatcher) in.read_Object(Dispatcher.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",onjlib.ejb.dispatcher.DispatcherHome.class);
            if (so == null) {
                return create();
            }
            try {
                Dispatcher result = ((onjlib.ejb.dispatcher.DispatcherHome)so.servant).create();
                return (Dispatcher)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
