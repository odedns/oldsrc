...
public class _Dispatcher_Stub extends Stub implements Dispatcher {
    ...
    public CommandParams executeCommand(CommandParams arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("executeCommand", true);
                    out.write_value(arg0,CommandParams.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CommandParams) in.read_value(CommandParams.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
                    throw new UnexpectedException(id);
                } catch (RemarshalException ex) {
                    return executeCommand(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("executeCommand",onjlib.ejb.dispatcher.Dispatcher.class);
            if (so == null) {
                return executeCommand(arg0);
            }
            try {
                CommandParams arg0Copy = (CommandParams) Util.copyObject(arg0,_orb());
                CommandParams result = ((onjlib.ejb.dispatcher.Dispatcher)so.servant).executeCommand(arg0Copy);
                return (CommandParams)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
