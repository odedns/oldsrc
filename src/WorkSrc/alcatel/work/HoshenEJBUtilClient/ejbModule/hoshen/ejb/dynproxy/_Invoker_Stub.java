...
public class _Invoker_Stub extends Stub implements Invoker {
    ...
    public Object invoke(Class arg0, String arg1, ArrayList arg2) throws Exception {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,Class.class);
                    out.write_value(arg1,String.class);
                    out.write_value(arg2,ArrayList.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return Util.readAny(in);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("invoke",hoshen.ejb.dynproxy.Invoker.class);
            if (so == null) {
                return invoke(arg0, arg1, arg2);
            }
            try {
                Object[] copies = Util.copyObjects(new Object[]{arg0,arg1,arg2},_orb());
                Class arg0Copy = (Class) copies[0];
                String arg1Copy = (String) copies[1];
                ArrayList arg2Copy = (ArrayList) copies[2];
                Object result = ((hoshen.ejb.dynproxy.Invoker)so.servant).invoke(arg0Copy, arg1Copy, arg2Copy);
                return (Object)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
