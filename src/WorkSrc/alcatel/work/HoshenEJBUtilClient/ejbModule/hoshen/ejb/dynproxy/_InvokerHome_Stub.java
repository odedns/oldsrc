...
public class _InvokerHome_Stub extends Stub implements InvokerHome {
    
    private static final String[] _type_ids = {
        "RMI:hoshen.ejb.dynproxy.InvokerHome:0000000000000000", 
    ...
    public Invoker create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Invoker) in.read_Object(Invoker.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",hoshen.ejb.dynproxy.InvokerHome.class);
            if (so == null) {
                return create();
            }
            try {
                Invoker result = ((hoshen.ejb.dynproxy.InvokerHome)so.servant).create();
                return (Invoker)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
