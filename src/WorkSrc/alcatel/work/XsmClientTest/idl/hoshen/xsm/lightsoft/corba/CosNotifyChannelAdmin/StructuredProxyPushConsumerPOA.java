...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/StructuredProxyPushConsumerPOA.java .
...
public abstract class StructuredProxyPushConsumerPOA extends org.omg.PortableServer.Servant
                implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushConsumerOperations, org.omg.CORBA.portable.InvokeHandler
{

  public hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushConsumer _this() {
     return hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushConsumerHelper.narrow(
        super._this_object());
  }

  public hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushConsumer _this(org.omg.CORBA.ORB orb) {
     return hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushConsumerHelper.narrow(
  ...
  /**
       ...
       */
       ...
       {
         try {
           hoshen.xsm.lightsoft.corba.CosNotifyComm.StructuredPushSupplier push_supplier = hoshen.xsm.lightsoft.corba.CosNotifyComm.StructuredPushSupplierHelper.read (in);
  ...
  /**
       ...
       */
       ...
       {
         try {
           hoshen.xsm.lightsoft.corba.CosNotification.StructuredEvent notification = hoshen.xsm.lightsoft.corba.CosNotification.StructuredEventHelper.read (in);
...
} // class _StructuredProxyPushConsumerPOA
