...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/_SequenceProxyPullSupplierStub.java .
...
/**
    ...
    */
public class _SequenceProxyPullSupplierStub extends org.omg.CORBA_2_3.portable.ObjectImpl implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPullSupplier
{
  // Constructors
  // NOTE:  If the default constructor is used, the
  //        object is useless until _set_delegate (...)
  //        is called.
  public _SequenceProxyPullSupplierStub ()
  {
    super ();
  }

  public _SequenceProxyPullSupplierStub (org.omg.CORBA.portable.Delegate delegate)
  {
    super ();
  ...
  /**
       ...
       */
  public void connect_sequence_pull_consumer (hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePullConsumer pull_consumer) throws hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.AlreadyConnected
  {
    while(true) {
      if ( !this._is_local() ) {
        org.omg.CORBA.portable.InputStream _in = null;
        try {
          org.omg.CORBA.portable.OutputStream _out = _request ("connect_sequence_pull_consumer",true);
          hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePullConsumerHelper.write (_out, pull_consumer);
          _in = _invoke (_out);
          return;
        ...
        org.omg.CORBA.portable.ServantObject _so =
          _servant_preinvoke( "connect_sequence_pull_consumer",_opsClass );
        if ( _so == null ) { 
          continue;
        }
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPullSupplierOperations)_so.servant).connect_sequence_pull_consumer( pull_consumer );
          return;
  ...
  final public static java.lang.Class _opsClass =
    hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPullSupplierOperations.class;
