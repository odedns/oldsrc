...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/_SequenceProxyPushSupplierStub.java .
...
/**
    ...
    */
public class _SequenceProxyPushSupplierStub extends org.omg.CORBA_2_3.portable.ObjectImpl implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushSupplier
{
  // Constructors
  // NOTE:  If the default constructor is used, the
  //        object is useless until _set_delegate (...)
  //        is called.
  public _SequenceProxyPushSupplierStub ()
  {
    super ();
  }

  public _SequenceProxyPushSupplierStub (org.omg.CORBA.portable.Delegate delegate)
  {
    super ();
  ...
  /**
       ...
       */
  public void connect_sequence_push_consumer (hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePushConsumer push_consumer) throws hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.AlreadyConnected, hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.TypeError
  {
    while(true) {
      if ( !this._is_local() ) {
        org.omg.CORBA.portable.InputStream _in = null;
        try {
          org.omg.CORBA.portable.OutputStream _out = _request ("connect_sequence_push_consumer",true);
          hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePushConsumerHelper.write (_out, push_consumer);
          _in = _invoke (_out);
          return;
        ...
        org.omg.CORBA.portable.ServantObject _so =
          _servant_preinvoke( "connect_sequence_push_consumer",_opsClass );
        if ( _so == null ) { 
          continue;
        }
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushSupplierOperations)_so.servant).connect_sequence_push_consumer( push_consumer );
          return;
  ...
  public void suspend_connection () throws hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ConnectionAlreadyInactive, hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.NotConnected
  {
    while(true) {
      if ( !this._is_local() ) {
        ...
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushSupplierOperations)_so.servant).suspend_connection(  );
          return;
        } finally { _servant_postinvoke( _so ); }
      }
    }
  ...
  public void resume_connection () throws hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ConnectionAlreadyActive, hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.NotConnected
  {
    while(true) {
      if ( !this._is_local() ) {
        ...
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushSupplierOperations)_so.servant).resume_connection(  );
          return;
        } finally { _servant_postinvoke( _so ); }
      }
    }
  ...
  final public static java.lang.Class _opsClass =
    hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushSupplierOperations.class;
