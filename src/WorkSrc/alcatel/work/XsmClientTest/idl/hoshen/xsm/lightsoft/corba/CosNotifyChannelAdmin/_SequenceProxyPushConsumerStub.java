...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/_SequenceProxyPushConsumerStub.java .
...
/**
    ...
    */
public class _SequenceProxyPushConsumerStub extends org.omg.CORBA_2_3.portable.ObjectImpl implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushConsumer
{
  // Constructors
  // NOTE:  If the default constructor is used, the
  //        object is useless until _set_delegate (...)
  //        is called.
  public _SequenceProxyPushConsumerStub ()
  {
    super ();
  }

  public _SequenceProxyPushConsumerStub (org.omg.CORBA.portable.Delegate delegate)
  {
    super ();
  ...
  /**
       ...
       */
  public void connect_sequence_push_supplier (hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePushSupplier push_supplier) throws hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.AlreadyConnected
  {
    while(true) {
      if ( !this._is_local() ) {
        org.omg.CORBA.portable.InputStream _in = null;
        try {
          org.omg.CORBA.portable.OutputStream _out = _request ("connect_sequence_push_supplier",true);
          hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePushSupplierHelper.write (_out, push_supplier);
          _in = _invoke (_out);
          return;
        ...
        org.omg.CORBA.portable.ServantObject _so =
          _servant_preinvoke( "connect_sequence_push_supplier",_opsClass );
        if ( _so == null ) { 
          continue;
        }
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushConsumerOperations)_so.servant).connect_sequence_push_supplier( push_supplier );
          return;
  ...
  public void push_structured_events (hoshen.xsm.lightsoft.corba.CosNotification.StructuredEvent[] notifications) throws hoshen.xsm.lightsoft.corba.CosEventComm.Disconnected
  {
    while(true) {
      if ( !this._is_local() ) {
        org.omg.CORBA.portable.InputStream _in = null;
        try {
          org.omg.CORBA.portable.OutputStream _out = _request ("push_structured_events",true);
          hoshen.xsm.lightsoft.corba.CosNotification.EventBatchHelper.write (_out, notifications);
          _in = _invoke (_out);
          return;
        } catch (org.omg.CORBA.portable.ApplicationException _ex) {
          _in = _ex.getInputStream ();
        ...
        org.omg.CORBA.portable.ServantObject _so =
          _servant_preinvoke( "push_structured_events",_opsClass );
        if ( _so == null ) { 
          continue;
        }
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePushConsumerOperations)_so.servant).push_structured_events( notifications );
          return;
        } finally { _servant_postinvoke( _so ); }
      }
    }
  ...
  public void disconnect_sequence_push_consumer ()
  {
    while(true) {
      if ( !this._is_local() ) {
        org.omg.CORBA.portable.InputStream _in = null;
        try {
          org.omg.CORBA.portable.OutputStream _out = _request ("disconnect_sequence_push_consumer",true);
          _in = _invoke (_out);
          return;
        } catch (org.omg.CORBA.portable.ApplicationException _ex) {
          _in = _ex.getInputStream ();
        ...
        org.omg.CORBA.portable.ServantObject _so =
          _servant_preinvoke( "disconnect_sequence_push_consumer",_opsClass );
        if ( _so == null ) { 
          continue;
        }
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePushConsumerOperations)_so.servant).disconnect_sequence_push_consumer(  );
          return;
        } finally { _servant_postinvoke( _so ); }
      }
    }
  ...
  final public static java.lang.Class _opsClass =
    hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushConsumerOperations.class;
