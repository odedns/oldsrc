...
/**
* hoshen/xsm/lightsoft/corba/CosTrading/PropertyHelper.java .
...
abstract public class PropertyHelper
{
    ...
    if (__typeCode == null)
    {
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _tcOf_members0 = org.omg.CORBA.ORB.init ().create_alias_tc (hoshen.xsm.lightsoft.corba.CosTrading.PropertyValueHelper.id (), "PropertyValue", _tcOf_members0);
          _members0[1] = new org.omg.CORBA.StructMember (
            "value",
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (hoshen.xsm.lightsoft.corba.CosTrading.PropertyHelper.id (), "Property", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    hoshen.xsm.lightsoft.corba.CosTrading.Property value = new hoshen.xsm.lightsoft.corba.CosTrading.Property ();
