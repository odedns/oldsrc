...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/SequenceProxyPushConsumerPOA.java .
...
public abstract class SequenceProxyPushConsumerPOA extends org.omg.PortableServer.Servant
                implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushConsumerOperations, org.omg.CORBA.portable.InvokeHandler
{

  public hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushConsumer _this() {
     return hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushConsumerHelper.narrow(
        super._this_object());
  }

  public hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushConsumer _this(org.omg.CORBA.ORB orb) {
     return hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushConsumerHelper.narrow(
  ...
  /**
       ...
       */
       ...
       {
         try {
           hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePushSupplier push_supplier = hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePushSupplierHelper.read (in);
...
} // class _SequenceProxyPushConsumerPOA
