...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/_ProxyPullConsumerStub.java .
...
/**
    ...
    */
public class _ProxyPullConsumerStub extends org.omg.CORBA_2_3.portable.ObjectImpl implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ProxyPullConsumer
{
  // Constructors
  ...
  public _ProxyPullConsumerStub (org.omg.CORBA.portable.Delegate delegate)
  {
    super ();
  ...
  /**
       ...
       */
  public void connect_any_pull_supplier (hoshen.xsm.lightsoft.corba.CosEventComm.PullSupplier pull_supplier) throws hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.AlreadyConnected, hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.TypeError
  {
    while(true) {
      if ( !this._is_local() ) {
        org.omg.CORBA.portable.InputStream _in = null;
        try {
          org.omg.CORBA.portable.OutputStream _out = _request ("connect_any_pull_supplier",true);
          hoshen.xsm.lightsoft.corba.CosEventComm.PullSupplierHelper.write (_out, pull_supplier);
          _in = _invoke (_out);
          return;
        ...
        org.omg.CORBA.portable.ServantObject _so =
          _servant_preinvoke( "connect_any_pull_supplier",_opsClass );
        if ( _so == null ) { 
          continue;
        }
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ProxyPullConsumerOperations)_so.servant).connect_any_pull_supplier( pull_supplier );
          return;
  ...
  public void suspend_connection () throws hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ConnectionAlreadyInactive, hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.NotConnected
  {
    while(true) {
      if ( !this._is_local() ) {
        ...
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ProxyPullConsumerOperations)_so.servant).suspend_connection(  );
          return;
        } finally { _servant_postinvoke( _so ); }
      }
    }
  ...
  public void resume_connection () throws hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ConnectionAlreadyActive, hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.NotConnected
  {
    while(true) {
      if ( !this._is_local() ) {
        ...
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ProxyPullConsumerOperations)_so.servant).resume_connection(  );
          return;
        } finally { _servant_postinvoke( _so ); }
      }
    }
  ...
  final public static java.lang.Class _opsClass =
    hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ProxyPullConsumerOperations.class;
