...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/_StructuredProxyPushSupplierStub.java .
...
/**
    ...
    */
public class _StructuredProxyPushSupplierStub extends org.omg.CORBA_2_3.portable.ObjectImpl implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushSupplier
{
  // Constructors
  // NOTE:  If the default constructor is used, the
  //        object is useless until _set_delegate (...)
  //        is called.
  public _StructuredProxyPushSupplierStub ()
  {
    super ();
  }

  public _StructuredProxyPushSupplierStub (org.omg.CORBA.portable.Delegate delegate)
  {
    super ();
  ...
  /**
       ...
       */
  public void connect_structured_push_consumer (hoshen.xsm.lightsoft.corba.CosNotifyComm.StructuredPushConsumer push_consumer) throws hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.AlreadyConnected, hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.TypeError
  {
    while(true) {
      if ( !this._is_local() ) {
        org.omg.CORBA.portable.InputStream _in = null;
        try {
          org.omg.CORBA.portable.OutputStream _out = _request ("connect_structured_push_consumer",true);
          hoshen.xsm.lightsoft.corba.CosNotifyComm.StructuredPushConsumerHelper.write (_out, push_consumer);
          _in = _invoke (_out);
          return;
        ...
        org.omg.CORBA.portable.ServantObject _so =
          _servant_preinvoke( "connect_structured_push_consumer",_opsClass );
        if ( _so == null ) { 
          continue;
        }
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushSupplierOperations)_so.servant).connect_structured_push_consumer( push_consumer );
          return;
  ...
  public void suspend_connection () throws hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ConnectionAlreadyInactive, hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.NotConnected
  {
    while(true) {
      if ( !this._is_local() ) {
        ...
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushSupplierOperations)_so.servant).suspend_connection(  );
          return;
        } finally { _servant_postinvoke( _so ); }
      }
    }
  ...
  public void resume_connection () throws hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ConnectionAlreadyActive, hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.NotConnected
  {
    while(true) {
      if ( !this._is_local() ) {
        ...
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushSupplierOperations)_so.servant).resume_connection(  );
          return;
        } finally { _servant_postinvoke( _so ); }
      }
    }
  ...
  public void disconnect_structured_push_supplier ()
  {
    while(true) {
      if ( !this._is_local() ) {
        org.omg.CORBA.portable.InputStream _in = null;
        try {
          org.omg.CORBA.portable.OutputStream _out = _request ("disconnect_structured_push_supplier",true);
          _in = _invoke (_out);
          return;
        } catch (org.omg.CORBA.portable.ApplicationException _ex) {
          _in = _ex.getInputStream ();
        ...
        org.omg.CORBA.portable.ServantObject _so =
          _servant_preinvoke( "disconnect_structured_push_supplier",_opsClass );
        if ( _so == null ) { 
          continue;
        }
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyComm.StructuredPushSupplierOperations)_so.servant).disconnect_structured_push_supplier(  );
          return;
        } finally { _servant_postinvoke( _so ); }
      }
    }
  ...
  final public static java.lang.Class _opsClass =
    hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushSupplierOperations.class;
