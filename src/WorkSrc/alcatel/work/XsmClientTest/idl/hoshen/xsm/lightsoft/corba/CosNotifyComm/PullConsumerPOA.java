...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyComm/PullConsumerPOA.java .
...
public abstract class PullConsumerPOA extends org.omg.PortableServer.Servant
                implements hoshen.xsm.lightsoft.corba.CosNotifyComm.PullConsumerOperations, org.omg.CORBA.portable.InvokeHandler
{

  public hoshen.xsm.lightsoft.corba.CosNotifyComm.PullConsumer _this() {
     return hoshen.xsm.lightsoft.corba.CosNotifyComm.PullConsumerHelper.narrow(
        super._this_object());
  }

  public hoshen.xsm.lightsoft.corba.CosNotifyComm.PullConsumer _this(org.omg.CORBA.ORB orb) {
     return hoshen.xsm.lightsoft.corba.CosNotifyComm.PullConsumerHelper.narrow(
