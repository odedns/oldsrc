...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/_ProxyPullSupplierStub.java .
...
/**
    ...
    */
public class _ProxyPullSupplierStub extends org.omg.CORBA_2_3.portable.ObjectImpl implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ProxyPullSupplier
{
  // Constructors
  ...
  /**
       ...
       */
  public void connect_any_pull_consumer (hoshen.xsm.lightsoft.corba.CosEventComm.PullConsumer pull_consumer) throws hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.AlreadyConnected
  {
    while(true) {
      if ( !this._is_local() ) {
        org.omg.CORBA.portable.InputStream _in = null;
        try {
          org.omg.CORBA.portable.OutputStream _out = _request ("connect_any_pull_consumer",true);
        ...
        org.omg.CORBA.portable.ServantObject _so =
          _servant_preinvoke( "connect_any_pull_consumer",_opsClass );
        if ( _so == null ) { 
          continue;
        }
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ProxyPullSupplierOperations)_so.servant).connect_any_pull_consumer( pull_consumer );
          return;
  ...
  final public static java.lang.Class _opsClass =
    hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ProxyPullSupplierOperations.class;
