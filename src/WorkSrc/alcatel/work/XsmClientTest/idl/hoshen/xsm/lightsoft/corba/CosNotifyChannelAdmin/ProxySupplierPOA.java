...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/ProxySupplierPOA.java .
...
public abstract class ProxySupplierPOA extends org.omg.PortableServer.Servant
                implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ProxySupplierOperations, org.omg.CORBA.portable.InvokeHandler
{

  public hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ProxySupplier _this() {
     return hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ProxySupplierHelper.narrow(
        super._this_object());
  }

  public hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ProxySupplier _this(org.omg.CORBA.ORB orb) {
     return hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ProxySupplierHelper.narrow(
