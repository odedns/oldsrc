...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyComm/NotifyPublishPOA.java .
...
public abstract class NotifyPublishPOA extends org.omg.PortableServer.Servant
                implements hoshen.xsm.lightsoft.corba.CosNotifyComm.NotifyPublishOperations, org.omg.CORBA.portable.InvokeHandler
{

  public hoshen.xsm.lightsoft.corba.CosNotifyComm.NotifyPublish _this() {
     return hoshen.xsm.lightsoft.corba.CosNotifyComm.NotifyPublishHelper.narrow(
        super._this_object());
  }

  public hoshen.xsm.lightsoft.corba.CosNotifyComm.NotifyPublish _this(org.omg.CORBA.ORB orb) {
     return hoshen.xsm.lightsoft.corba.CosNotifyComm.NotifyPublishHelper.narrow(
