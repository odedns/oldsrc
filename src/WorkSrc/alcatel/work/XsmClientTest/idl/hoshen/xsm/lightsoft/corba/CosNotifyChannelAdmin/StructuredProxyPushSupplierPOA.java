...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/StructuredProxyPushSupplierPOA.java .
...
public abstract class StructuredProxyPushSupplierPOA extends org.omg.PortableServer.Servant
                implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushSupplierOperations, org.omg.CORBA.portable.InvokeHandler
{

  public hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushSupplier _this() {
     return hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushSupplierHelper.narrow(
        super._this_object());
  }

  public hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushSupplier _this(org.omg.CORBA.ORB orb) {
     return hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushSupplierHelper.narrow(
  ...
  /**
       ...
       */
       ...
       {
         try {
           hoshen.xsm.lightsoft.corba.CosNotifyComm.StructuredPushConsumer push_consumer = hoshen.xsm.lightsoft.corba.CosNotifyComm.StructuredPushConsumerHelper.read (in);
...
} // class _StructuredProxyPushSupplierPOA
