...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/SequenceProxyPushSupplierPOA.java .
...
public abstract class SequenceProxyPushSupplierPOA extends org.omg.PortableServer.Servant
                implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushSupplierOperations, org.omg.CORBA.portable.InvokeHandler
{

  public hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushSupplier _this() {
     return hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushSupplierHelper.narrow(
        super._this_object());
  }

  public hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushSupplier _this(org.omg.CORBA.ORB orb) {
     return hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPushSupplierHelper.narrow(
  ...
  /**
       ...
       */
       ...
       {
         try {
           hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePushConsumer push_consumer = hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePushConsumerHelper.read (in);
...
} // class _SequenceProxyPushSupplierPOA
