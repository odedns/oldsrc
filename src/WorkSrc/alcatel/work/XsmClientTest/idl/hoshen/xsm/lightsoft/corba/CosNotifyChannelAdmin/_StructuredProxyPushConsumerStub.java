...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/_StructuredProxyPushConsumerStub.java .
...
/**
    ...
    */
public class _StructuredProxyPushConsumerStub extends org.omg.CORBA_2_3.portable.ObjectImpl implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushConsumer
{
  // Constructors
  // NOTE:  If the default constructor is used, the
  //        object is useless until _set_delegate (...)
  //        is called.
  public _StructuredProxyPushConsumerStub ()
  {
    super ();
  }

  public _StructuredProxyPushConsumerStub (org.omg.CORBA.portable.Delegate delegate)
  {
    super ();
  ...
  /**
       ...
       */
  public void connect_structured_push_supplier (hoshen.xsm.lightsoft.corba.CosNotifyComm.StructuredPushSupplier push_supplier) throws hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.AlreadyConnected
  {
    while(true) {
      if ( !this._is_local() ) {
        org.omg.CORBA.portable.InputStream _in = null;
        try {
          org.omg.CORBA.portable.OutputStream _out = _request ("connect_structured_push_supplier",true);
          hoshen.xsm.lightsoft.corba.CosNotifyComm.StructuredPushSupplierHelper.write (_out, push_supplier);
          _in = _invoke (_out);
          return;
        ...
        org.omg.CORBA.portable.ServantObject _so =
          _servant_preinvoke( "connect_structured_push_supplier",_opsClass );
        if ( _so == null ) { 
          continue;
        }
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushConsumerOperations)_so.servant).connect_structured_push_supplier( push_supplier );
          return;
  ...
  final public static java.lang.Class _opsClass =
    hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPushConsumerOperations.class;
