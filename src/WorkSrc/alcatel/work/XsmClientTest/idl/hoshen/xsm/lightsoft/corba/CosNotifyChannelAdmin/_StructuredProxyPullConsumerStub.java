...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/_StructuredProxyPullConsumerStub.java .
...
/**
    ...
    */
public class _StructuredProxyPullConsumerStub extends org.omg.CORBA_2_3.portable.ObjectImpl implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPullConsumer
{
  // Constructors
  // NOTE:  If the default constructor is used, the
  //        object is useless until _set_delegate (...)
  //        is called.
  public _StructuredProxyPullConsumerStub ()
  {
    super ();
  }

  public _StructuredProxyPullConsumerStub (org.omg.CORBA.portable.Delegate delegate)
  {
    super ();
  ...
  /**
       ...
       */
  public void connect_structured_pull_supplier (hoshen.xsm.lightsoft.corba.CosNotifyComm.StructuredPullSupplier pull_supplier) throws hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.AlreadyConnected, hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.TypeError
  {
    while(true) {
      if ( !this._is_local() ) {
        org.omg.CORBA.portable.InputStream _in = null;
        try {
          org.omg.CORBA.portable.OutputStream _out = _request ("connect_structured_pull_supplier",true);
          hoshen.xsm.lightsoft.corba.CosNotifyComm.StructuredPullSupplierHelper.write (_out, pull_supplier);
          _in = _invoke (_out);
          return;
        ...
        org.omg.CORBA.portable.ServantObject _so =
          _servant_preinvoke( "connect_structured_pull_supplier",_opsClass );
        if ( _so == null ) { 
          continue;
        }
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPullConsumerOperations)_so.servant).connect_structured_pull_supplier( pull_supplier );
          return;
  ...
  public void suspend_connection () throws hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ConnectionAlreadyInactive, hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.NotConnected
  {
    while(true) {
      if ( !this._is_local() ) {
        ...
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPullConsumerOperations)_so.servant).suspend_connection(  );
          return;
        } finally { _servant_postinvoke( _so ); }
      }
    }
  ...
  public void resume_connection () throws hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ConnectionAlreadyActive, hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.NotConnected
  {
    while(true) {
      if ( !this._is_local() ) {
        ...
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPullConsumerOperations)_so.servant).resume_connection(  );
          return;
        } finally { _servant_postinvoke( _so ); }
      }
    }
  ...
  public void disconnect_structured_pull_consumer ()
  {
    while(true) {
      if ( !this._is_local() ) {
        org.omg.CORBA.portable.InputStream _in = null;
        try {
          org.omg.CORBA.portable.OutputStream _out = _request ("disconnect_structured_pull_consumer",true);
          _in = _invoke (_out);
          return;
        } catch (org.omg.CORBA.portable.ApplicationException _ex) {
          _in = _ex.getInputStream ();
        ...
        org.omg.CORBA.portable.ServantObject _so =
          _servant_preinvoke( "disconnect_structured_pull_consumer",_opsClass );
        if ( _so == null ) { 
          continue;
        }
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyComm.StructuredPullConsumerOperations)_so.servant).disconnect_structured_pull_consumer(  );
          return;
        } finally { _servant_postinvoke( _so ); }
      }
    }
  ...
  final public static java.lang.Class _opsClass =
    hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPullConsumerOperations.class;
