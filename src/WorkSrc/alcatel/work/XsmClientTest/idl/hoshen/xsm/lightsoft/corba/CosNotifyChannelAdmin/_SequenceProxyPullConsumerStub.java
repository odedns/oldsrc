...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/_SequenceProxyPullConsumerStub.java .
...
/**
    ...
    */
public class _SequenceProxyPullConsumerStub extends org.omg.CORBA_2_3.portable.ObjectImpl implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPullConsumer
{
  // Constructors
  // NOTE:  If the default constructor is used, the
  //        object is useless until _set_delegate (...)
  //        is called.
  public _SequenceProxyPullConsumerStub ()
  {
    super ();
  }

  public _SequenceProxyPullConsumerStub (org.omg.CORBA.portable.Delegate delegate)
  {
    super ();
  ...
  /**
       ...
       */
  public void connect_sequence_pull_supplier (hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePullSupplier pull_supplier) throws hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.AlreadyConnected, hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.TypeError
  {
    while(true) {
      if ( !this._is_local() ) {
        org.omg.CORBA.portable.InputStream _in = null;
        try {
          org.omg.CORBA.portable.OutputStream _out = _request ("connect_sequence_pull_supplier",true);
          hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePullSupplierHelper.write (_out, pull_supplier);
          _in = _invoke (_out);
          return;
        ...
        org.omg.CORBA.portable.ServantObject _so =
          _servant_preinvoke( "connect_sequence_pull_supplier",_opsClass );
        if ( _so == null ) { 
          continue;
        }
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPullConsumerOperations)_so.servant).connect_sequence_pull_supplier( pull_supplier );
          return;
  ...
  public void suspend_connection () throws hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ConnectionAlreadyInactive, hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.NotConnected
  {
    while(true) {
      if ( !this._is_local() ) {
        ...
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPullConsumerOperations)_so.servant).suspend_connection(  );
          return;
        } finally { _servant_postinvoke( _so ); }
      }
    }
  ...
  public void resume_connection () throws hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.ConnectionAlreadyActive, hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.NotConnected
  {
    while(true) {
      if ( !this._is_local() ) {
        ...
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPullConsumerOperations)_so.servant).resume_connection(  );
          return;
        } finally { _servant_postinvoke( _so ); }
      }
    }
  ...
  public void disconnect_sequence_pull_consumer ()
  {
    while(true) {
      if ( !this._is_local() ) {
        org.omg.CORBA.portable.InputStream _in = null;
        try {
          org.omg.CORBA.portable.OutputStream _out = _request ("disconnect_sequence_pull_consumer",true);
          _in = _invoke (_out);
          return;
        } catch (org.omg.CORBA.portable.ApplicationException _ex) {
          _in = _ex.getInputStream ();
        ...
        org.omg.CORBA.portable.ServantObject _so =
          _servant_preinvoke( "disconnect_sequence_pull_consumer",_opsClass );
        if ( _so == null ) { 
          continue;
        }
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePullConsumerOperations)_so.servant).disconnect_sequence_pull_consumer(  );
          return;
        } finally { _servant_postinvoke( _so ); }
      }
    }
  ...
  final public static java.lang.Class _opsClass =
    hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPullConsumerOperations.class;
