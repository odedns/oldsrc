...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/_StructuredProxyPullSupplierStub.java .
...
/**
    ...
    */
public class _StructuredProxyPullSupplierStub extends org.omg.CORBA_2_3.portable.ObjectImpl implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPullSupplier
{
  // Constructors
  // NOTE:  If the default constructor is used, the
  //        object is useless until _set_delegate (...)
  //        is called.
  public _StructuredProxyPullSupplierStub ()
  {
    super ();
  }

  public _StructuredProxyPullSupplierStub (org.omg.CORBA.portable.Delegate delegate)
  {
    super ();
  ...
  /**
       ...
       */
  public void connect_structured_pull_consumer (hoshen.xsm.lightsoft.corba.CosNotifyComm.StructuredPullConsumer pull_consumer) throws hoshen.xsm.lightsoft.corba.CosEventChannelAdmin.AlreadyConnected
  {
    while(true) {
      if ( !this._is_local() ) {
        org.omg.CORBA.portable.InputStream _in = null;
        try {
          org.omg.CORBA.portable.OutputStream _out = _request ("connect_structured_pull_consumer",true);
          hoshen.xsm.lightsoft.corba.CosNotifyComm.StructuredPullConsumerHelper.write (_out, pull_consumer);
          _in = _invoke (_out);
          return;
        ...
        org.omg.CORBA.portable.ServantObject _so =
          _servant_preinvoke( "connect_structured_pull_consumer",_opsClass );
        if ( _so == null ) { 
          continue;
        }
        try {
          ((hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPullSupplierOperations)_so.servant).connect_structured_pull_consumer( pull_consumer );
          return;
  ...
  final public static java.lang.Class _opsClass =
    hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.StructuredProxyPullSupplierOperations.class;
