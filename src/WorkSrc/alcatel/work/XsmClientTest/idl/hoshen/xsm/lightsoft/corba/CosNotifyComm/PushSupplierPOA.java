...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyComm/PushSupplierPOA.java .
...
public abstract class PushSupplierPOA extends org.omg.PortableServer.Servant
                implements hoshen.xsm.lightsoft.corba.CosNotifyComm.PushSupplierOperations, org.omg.CORBA.portable.InvokeHandler
{

  public hoshen.xsm.lightsoft.corba.CosNotifyComm.PushSupplier _this() {
     return hoshen.xsm.lightsoft.corba.CosNotifyComm.PushSupplierHelper.narrow(
        super._this_object());
  }

  public hoshen.xsm.lightsoft.corba.CosNotifyComm.PushSupplier _this(org.omg.CORBA.ORB orb) {
     return hoshen.xsm.lightsoft.corba.CosNotifyComm.PushSupplierHelper.narrow(
