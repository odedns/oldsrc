...
/**
* hoshen/xsm/lightsoft/corba/CosNotifyChannelAdmin/SequenceProxyPullSupplierPOA.java .
...
public abstract class SequenceProxyPullSupplierPOA extends org.omg.PortableServer.Servant
                implements hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPullSupplierOperations, org.omg.CORBA.portable.InvokeHandler
{

  public hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPullSupplier _this() {
     return hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPullSupplierHelper.narrow(
        super._this_object());
  }

  public hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPullSupplier _this(org.omg.CORBA.ORB orb) {
     return hoshen.xsm.lightsoft.corba.CosNotifyChannelAdmin.SequenceProxyPullSupplierHelper.narrow(
  ...
  /**
       ...
       */
       ...
       {
         try {
           hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePullConsumer pull_consumer = hoshen.xsm.lightsoft.corba.CosNotifyComm.SequencePullConsumerHelper.read (in);
...
} // class _SequenceProxyPullSupplierPOA
