...
public class DataCompressor {
	...
	public static void main(String args[]) 
	{
		...
		String s = "Some fucking very very long String kjflkjlkjglkjfglkjkg gjg jgjgjjgjg gjgjgjgglgl  gjgjgjgj gjgjgjgjg";
		try {		
			System.out.println("input str = " + s + " input len = " + s.length());
			String outStr = DataCompressor.compress(s);
			System.out.println("after compress s = " + outStr + " len = " + outStr.length());
//			String outStr = new String(out,"UTF-8");
			s = DataCompressor.uncompress(outStr);
			System.out.println("after decompress s = " + s);
