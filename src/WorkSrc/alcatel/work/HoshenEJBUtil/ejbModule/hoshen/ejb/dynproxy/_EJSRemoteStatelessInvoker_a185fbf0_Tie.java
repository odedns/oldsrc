...
public class _EJSRemoteStatelessInvoker_a185fbf0_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessInvoker_a185fbf0 target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:hoshen.ejb.dynproxy.Invoker:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessInvoker_a185fbf0) target;
    }
    ...
    private org.omg.CORBA.portable.OutputStream invoke(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Class arg0 = (Class) in.read_value(Class.class);
        String arg1 = (String) in.read_value(String.class);
        ArrayList arg2 = (ArrayList) in.read_value(ArrayList.class);
        Object result;
        try {
            result = target.invoke(arg0, arg1, arg2);
        } catch (Exception ex) {
