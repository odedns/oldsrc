...
static Connection getThinConnection() throws Exception
{
      Driver drv = (Driver) Class.forName("com.ibm.db2.jcc.DB2Driver").newInstance();
      String url = "jdbc:db2://localhost:50000/WKSLOCAL";
      Connection c =java.sql.DriverManager.getConnection(url,"odedn","odedn01");
      return(c);
...
static Connection getConnection() throws Exception
{
	...
	props.load(new FileInputStream("d:/work/jndi.properties"));
	context = new javax.naming.InitialContext(props);
	hash = context.getEnvironment();
