...
public class EventNotifier implements EventNotifierIF {
	 ...
	 * the list.
	 * @see patterns.EventNotifierIF#addHandler(EventHandlerIF)
	 */
	 ...
	 * the list.
	 * @see patterns.EventNotifierIF#removeHandler(EventHandlerIF)
	 */
	 ...
	 * @see patterns.EventNotifierIF#sendEvent(EventObject)
	 */
