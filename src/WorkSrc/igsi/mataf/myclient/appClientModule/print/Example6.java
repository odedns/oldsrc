 ...
 * Class: Example6 <p>
 *
 * Example on how to print an image.<p>
 *
...
public class Example6  {
    ...
    * it will print an image of the Nasa Space Station with a border arround it.<p>
    *
    *
    * @author Jean-Pierre Dube <jpdube@videotron.ca>
    * @version 1.0
   ...
   private class Document extends Component implements Printable {
      ...
      public int print (Graphics g, PageFormat pageFormat, int page) {
         ...
         //--- NOTE: Only the following image type are supported JPEG, GIF and PNG.
         try {
            
            imageURL = new URL ("file:///c:/softdev/java/articles/javaworld/printing/part_2/ss2.jpg");
         }
         ...
         g2d.drawImage (image,
                        ...
                        (int) (0.25 * POINTS_PER_INCH),
                        (int) (8.5 * POINTS_PER_INCH),
                        (int) (6 * POINTS_PER_INCH),
                        this);
