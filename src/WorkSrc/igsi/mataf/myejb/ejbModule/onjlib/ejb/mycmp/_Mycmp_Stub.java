...
public class _Mycmp_Stub extends Stub implements Mycmp {
    
    private static final String[] _type_ids = {
        "RMI:onjlib.ejb.mycmp.Mycmp:0000000000000000", 
    ...
    public String getName() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_name",onjlib.ejb.mycmp.Mycmp.class);
            if (so == null) {
                return getName();
            }
            try {
                return ((onjlib.ejb.mycmp.Mycmp)so.servant).getName();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setName(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_name",onjlib.ejb.mycmp.Mycmp.class);
            if (so == null) {
                setName(arg0);
                return;
            }
            try {
                ((onjlib.ejb.mycmp.Mycmp)so.servant).setName(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public String getDescription() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_description",onjlib.ejb.mycmp.Mycmp.class);
            if (so == null) {
                return getDescription();
            }
            try {
                return ((onjlib.ejb.mycmp.Mycmp)so.servant).getDescription();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setDescription(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_description",onjlib.ejb.mycmp.Mycmp.class);
            if (so == null) {
                setDescription(arg0);
                return;
            }
            try {
                ((onjlib.ejb.mycmp.Mycmp)so.servant).setDescription(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
