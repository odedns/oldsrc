...
public class _MysessionHome_Stub extends Stub implements MysessionHome {
    
    private static final String[] _type_ids = {
        "RMI:onjlib.ejb.mysession.MysessionHome:0000000000000000", 
    ...
    public Mysession create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Mysession) in.read_Object(Mysession.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",onjlib.ejb.mysession.MysessionHome.class);
            if (so == null) {
                return create();
            }
            try {
                Mysession result = ((onjlib.ejb.mysession.MysessionHome)so.servant).create();
                return (Mysession)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
