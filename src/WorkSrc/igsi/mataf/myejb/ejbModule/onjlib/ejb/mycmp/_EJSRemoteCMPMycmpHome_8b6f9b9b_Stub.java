...
import onjlib.ejb.mycmp.websphere_deploy.MycmpBeanInternalHome_8b6f9b9b;
import org.omg.CORBA.SystemException;
import org.omg.CORBA.portable.ApplicationException;
import org.omg.CORBA.portable.RemarshalException;
import org.omg.CORBA.portable.ServantObject;

public class _EJSRemoteCMPMycmpHome_8b6f9b9b_Stub extends Stub implements MycmpHome,
MycmpBeanInternalHome_8b6f9b9b {
    
    private static final String[] _type_ids = {
        "RMI:onjlib.ejb.mycmp.EJSRemoteCMPMycmpHome_8b6f9b9b:0000000000000000", 
        "RMI:onjlib.ejb.mycmp.MycmpHome:0000000000000000", 
        "RMI:javax.ejb.EJBHome:0000000000000000", 
        "RMI:onjlib.ejb.mycmp.websphere_deploy.MycmpBeanInternalHome_8b6f9b9b:0000000000000000", 
    ...
    public Mycmp create(Integer arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Mycmp) in.read_Object(Mycmp.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",onjlib.ejb.mycmp.MycmpHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Mycmp result = ((onjlib.ejb.mycmp.MycmpHome)so.servant).create(arg0Copy);
                return (Mycmp)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Mycmp findByPrimaryKey(Integer arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",onjlib.ejb.mycmp.MycmpHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Mycmp result = ((onjlib.ejb.mycmp.MycmpHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Mycmp)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
