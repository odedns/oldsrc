	...
	*/
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		throws ServletException, IOException {
			...
			try {
				if(length > 0) {	
					CommandParams params = (CommandParams) ois.readObject();
					String srvCmd = params.getCommandClassName();
					ServerCommand cmd = (ServerCommand) Class.forName(srvCmd).newInstance();
					CommandParams out = cmd.execute(params);
