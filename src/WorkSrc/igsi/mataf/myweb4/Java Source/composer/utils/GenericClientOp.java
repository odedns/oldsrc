...
import composer.utils.ContextFormatter;
...
public class GenericClientOp extends DSEClientOperation {
		...
		throws Exception
	{
		...
		String ctxData = ContextFormatter.formatClientContext(ctx,m_passGlobals);
		setValueAt("ctxData",ctxData);
		
	}
	
	/**
	 * set the value of the pass globals var.
	 */
	public void setPassGlobals(boolean flag)
	{
		m_passGlobals = flag;	
	}
