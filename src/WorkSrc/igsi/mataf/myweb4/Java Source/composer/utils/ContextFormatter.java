...
public class ContextFormatter {	
	private static KeyedCollectionFormat m_fmt = new DynamicXMLFormat();	
	/**
	...
	public static void setFormatter(KeyedCollectionFormat fmt)
	{
		m_fmt = fmt;	
	}
	...
	public static synchronized String formatContext(Context ctx)
		throws Exception
	{
		if(m_fmt instanceof DynamicXMLFormat) {
