 ...
 */
public class StartupBTServerOp extends DSEServerOperation {
	/**
	 * This constructor creates a StartupServerOp object. 
	 */
	public StartupBTServerOp() {
		super();
	}
	/**
	 * This constructor creates a StartupServerOp object. 
	 ...
	 */
	public StartupBTServerOp(String anOperationName) throws java.io.IOException {
	 ...
	 */
	public StartupBTServerOp(String anOperationName, String aParentContext)
		throws
			java.io.IOException,
	 ...
	 * @exception com.ibm.dse.base.DSEInvalidRequestException.
	 */
	public StartupBTServerOp(String anOperationName, Context aParentContext)
