 ...
 */
public class HalbanatHonPhoneServerOp extends DSEServerOperation 
{
	public void execute() throws Exception 
	{
		String screenKidoment = (String)getValueAt("GLSX_K86P_RESULT.HA_PHONE_NUM1");
		...
		else
		{
			...
			{
				HalbanatHonUtil.addErrorMsg(getContext(), "runtimeMsgs", "OL166");
