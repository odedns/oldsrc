...
public class _AuditDataHome_Stub extends Stub implements AuditDataHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ibm.AuditDataHome:0000000000000000", 
    ...
    public AuditData create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AuditData) in.read_Object(AuditData.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.ibm.AuditDataHome.class);
            if (so == null) {
                return create();
            }
            try {
                AuditData result = ((com.ibm.AuditDataHome)so.servant).create();
                return (AuditData)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
