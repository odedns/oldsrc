...
public class _AuditData_Stub extends Stub implements AuditData {
    ...
    public AuditDataResult queryActivityAudit(PIID arg0) throws Exception, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("queryActivityAudit", true);
                    out.write_value((Serializable)arg0,PIID.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AuditDataResult) in.read_value(AuditDataResult.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
                    ...
                    return queryActivityAudit(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("queryActivityAudit",com.ibm.AuditData.class);
            if (so == null) {
                return queryActivityAudit(arg0);
            }
            try {
                PIID arg0Copy = (PIID) Util.copyObject(arg0,_orb());
                AuditDataResult result = ((com.ibm.AuditData)so.servant).queryActivityAudit(arg0Copy);
                return (AuditDataResult)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
