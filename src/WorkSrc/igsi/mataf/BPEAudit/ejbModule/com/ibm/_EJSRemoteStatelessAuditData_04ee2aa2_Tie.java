...
public class _EJSRemoteStatelessAuditData_04ee2aa2_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessAuditData_04ee2aa2 target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:com.ibm.AuditData:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessAuditData_04ee2aa2) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                case 65: 
                    if (method.equals("queryActivityAudit")) {
                        return queryActivityAudit(in, reply);
                    }
                case 69: 
    ...
    private org.omg.CORBA.portable.OutputStream queryActivityAudit(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIID arg0 = (PIID) in.read_value(PIID.class);
        AuditDataResult result;
        try {
            result = target.queryActivityAudit(arg0);
        } catch (Exception ex) {
        ...
        out.write_value(result,AuditDataResult.class);
        return out;
    }
}
