 ...
 */
public StartupServerOp(String anOperationName, String aParentContext) throws java.io.IOException, DSEInvalidRequestException, DSEObjectNotFoundException {
 ...
 * @exception com.ibm.dse.base.DSEInvalidRequestException.
 */
public StartupServerOp(String anOperationName, Context aParentContext) throws java.io.IOException, DSEInvalidRequestException {
	super(anOperationName, aParentContext);
}
/**
...
public void execute() throws Exception {
	...
	if (parentContext==null) parentContext = (Context) Context.readObject((String)getValueAt("WKSParentContext"));//$NON-NLS-1$
