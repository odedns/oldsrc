...
public static KeyedCollection find(IndexedCollection ic, String name, String value)
{
	String curr=null;
	...
	try {
		for(int i=0; i < ic.size(); ++i) {
			...
			curr = (String) kc.getValueAt(name);
...
public static int findIndex(IndexedCollection ic, String name, String value)
{
	String curr=null;
	KeyedCollection kc = null;
	int inx = -1;
 ...
 * @author: Oded
 */
public static boolean contains(IndexedCollection ic, String name, String value)
{
