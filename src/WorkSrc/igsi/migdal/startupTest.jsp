...
<%@ include file="../general/init.jsp" %>
 
<html>
 <head>
 <META http-equiv="Content-Style-Type" content="text/css">
 <LINK href="<%=web_path%>/js/Main.css" REL=STYLESHEET TYPE="text/css">
 <title>Startup page</title>
 </head>
<body>
<br><br><br>

<form name="hitomForm" method=post action="<%=web_path%><%=CSRequestServlet%>">
